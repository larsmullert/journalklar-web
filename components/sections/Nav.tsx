    ...
    <nav className="sticky top-0 z-[500] bg-parchment/[0.94] backdrop-blur-[14px] border-b border-sand">
      <div className="max-w-[1100px] mx-auto px-6 md:px-16 py-5 flex items-center justify-between">
        ...
        <div className="flex items-center gap-6 md:gap-9">
          <a href="/saadan-virker-journalklar" className="hidden md:block font-sans text-[14px] font-normal text-evergreen hover:text-evergreen transition-colors border-b pb-[2px]" style={{ borderColor: "#E04500" }}>
            Sådan virker det
          </a>
